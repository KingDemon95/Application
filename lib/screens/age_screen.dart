            ...
            children: [
              ...
              SliderTheme(
                data: SliderTheme.of(context).copyWith(
                  ...
                  overlayColor: context.vx.primary.withValues(alpha: 0.12),
                ...
                child: Slider(
                  ...
                  max: 1200,
                  divisions: 1200,
                  onChanged: (val) => setState(() => _usiaBulan = val),
                ),
              ),
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Text('0', style: GoogleFonts.poppins(fontSize: 11, color: context.vx.textLight)),
                    Text('300', style: GoogleFonts.poppins(fontSize: 11, color: context.vx.textLight)),
                    Text('600', style: GoogleFonts.poppins(fontSize: 11, color: context.vx.textLight)),
                    Text('900', style: GoogleFonts.poppins(fontSize: 11, color: context.vx.textLight)),
                    Text('1200', style: GoogleFonts.poppins(fontSize: 11, color: context.vx.textLight)),
                  ],
                ),
              ),
              Padding(
                ...
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text('bayi', style: GoogleFonts.poppins(fontSize: 10, color: context.vx.textLight)),
                    const Spacer(),
                    Text('100 thn', style: GoogleFonts.poppins(fontSize: 10, color: context.vx.textLight)),
                  ],
                ),
              ),
